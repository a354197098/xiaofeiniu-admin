  ...
  <div class="xfn-category-list">
    ...
    <el-table :data="categoryList" stripe border>
      ...
      <el-table-column label="操作">
        ...
        <el-button size="mini" @click="updateCategory(row,$index)" type="success">修改</el-button>
        <el-button size="mini" @click="deleteCategory(row,$index)" type="danger">删除</el-button>
        </template>
